...
TERMUX_PKG_DEPENDS="libavcodec, libavutil, libavformat, libswresample" #"libftxui"
TERMUX_PKG_BUILD_DEPENDS="libavcodec, libavutil, libavformat, libswresample" #"libftxui"TERMUX_PKG_BUILD_DEPENDS="libftxui"
